...
// Registrating message process procedure
...
// Ignoring CR and LF generated by console input
void ignore_CRLF(char *c)
{
    for(; *c!='\0'; c++) if(*c=='\r' || *c=='\n') *c=' ';
}

// Adding the label showing the sender of particular message,
// and possible high-light color in the future
